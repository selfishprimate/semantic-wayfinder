// app/about/page.tsx — BEFORE Semantic Wayfinder
//
// Every section uses utility classes only. The components are visually
// distinct but textually indistinguishable to an AI agent — they all
// start with <section className="..."> and a pile of utilities.
